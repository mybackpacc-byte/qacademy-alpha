// ============================================================
// app/functions/api/email.js
// QAcademy Nurses Hub — Transactional email via Resend
// Exact copy of app/workers/auth-worker/email.js
...
<body>
  <div class="container">
    ...
    <p style="font-size:14px;color:#0f172a;margin-bottom:14px;">
      Thank you for creating your QAcademy account.
      You're now set up and ready to start exploring your courses and quizzes.
    </p>
    <div class="panel">
    ...
    <div class="footer">
      ...
      If you did not create this account, please contact us at ${SUPPORT_EMAIL}.
    </div>
  </div>
</body>
</html>`;
